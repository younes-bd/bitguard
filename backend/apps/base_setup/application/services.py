...
class SettingsService(BaseService):
    ...
    def get_system_metrics(self):
        ...
        from apps.base_setup.domain.models import ErpModule, WebhookEndpoint, DatabaseBackup
        ...
        installed_apps = ErpModule.objects.filter(is_installed=True).count()
    ...
    def create_api_key(self, name, user, tenant=None):
        import secrets
        import hashlib
        from ..domain.models import PlatformAPIKey

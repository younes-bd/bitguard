...
class SysadminAPITests(APITestCase):
    def setUp(self):
        ...
        # URLs
        self.settings_list_url = reverse('sysadmin-setting-list')
        self.metrics_url = reverse('sysadmin-setting-metrics')
        self.clear_cache_url = reverse('sysadmin-setting-clear-cache')
        self.sync_indexes_url = reverse('sysadmin-setting-sync-indexes')
        self.toggle_maintenance_url = reverse('sysadmin-setting-toggle-maintenance')
        self.batch_update_url = reverse('sysadmin-setting-batch-update')
        self.generate_report_url = reverse('sysadmin-setting-generate-report')
        self.audit_list_url = reverse('sysadmin-audit-list')
        self.export_csv_url = reverse('sysadmin-audit-export-csv')
    ...
    def test_batch_update_settings(self):
        ...
        self.assertTrue(AuditLog.objects.filter(resource_type="SystemSetting", resource_id="company_name").exists())

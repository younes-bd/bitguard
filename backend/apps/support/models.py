...
class KnowledgeArticle(UUIDPrimaryKeyModel, TimeStampedModel, SoftDeleteModel):
    tenant = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE, related_name='knowledge_articles', null=True, blank=True)
    title = models.CharField(max_length=255)

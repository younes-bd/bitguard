...
from .serializers import AssetListSerializer, AssetDetailSerializer, AssetAssignmentSerializer, MaintenanceRecordSerializer, SoftwareLicenseSerializer
from .models import Asset, AssetAssignment, MaintenanceRecord, SoftwareLicense

...
const SERVICES = {
    ...
    'incident-management': {
        ...
        description: 'Orchestrate and automate incident response across your entire security stack.',
        icon: 'bi bi-exclamation-triangle',
        hero_bg: 'linear-gradient(135deg, #034484 0%, #be123c 100%)',
        hero_image: '/assets/images/home/security-shield.png',
        long_description: `
            <p>When a breach occurs, seconds matter. Our Incident Management module provides automated response playbooks 
            that drastically reduce your mean-time-to-respond (MTTR) and contain threats before they escalate.</p>
            <p>By integrating directly with your endpoints, firewalls, and IAM providers, the platform can automatically 
            isolate compromised hosts, revoke access keys, and alert the appropriate teams.</p>
        `,
        features: [
            { title: 'Automated Playbooks', desc: 'Pre-built workflows for common threat scenarios like ransomware and phishing.', icon: 'bi bi-diagram-3' },
            { title: 'Case Management', desc: 'Centralized ticketing and evidence gathering for security analysts.', icon: 'bi bi-folder-check' },
            { title: 'One-Click Mitigation', desc: 'Isolate hosts or block IPs with a single click from the dashboard.', icon: 'bi bi-lightning-charge' }
        ],
        benefits: [
            { title: 'Faster Resolution', description: 'Reduce response times from hours to minutes.', icon: 'bi bi-stopwatch' },
            { title: 'Minimize Impact', description: 'Contain threats before they spread laterally.', icon: 'bi bi-shield-lock' },
            { title: 'Audit Trails', description: 'Maintain complete logs of every action taken during an incident.', icon: 'bi bi-journal-check' }
        ],
        process: [
            { step: '01', title: 'Detect', description: 'Alert is ingested from SIEM or endpoint.' },
            { step: '02', title: 'Triage', description: 'Severity is automatically assessed.' },
            { step: '03', title: 'Execute', description: 'Response playbook is triggered.' }
        ],
        why_choose_us: {
            title: 'Smarter Incident Response',
            image: '/assets/images/home/dashboard-preview.png',
            points: [
                'Integrates with ServiceNow and Jira.',
                'Custom playbook builder with drag-and-drop interface.',
                'Post-incident reporting and metrics.'
            ]
        },
        faq: [
            { question: 'Can we require human approval?', answer: 'Yes, playbooks can pause for manual authorization before taking disruptive actions.' },
            { question: 'What systems are supported?', answer: 'We integrate with over 100+ standard security and IT tools.' }
        ],
        content: ``
    },
    'log-analysis': {
        title: 'Log Analysis (SIEM)',
        subtitle: 'Centralized Log Aggregation',
        description: 'Collect, correlate, and analyze logs from every device in your network.',
        icon: 'bi bi-journal-text',
        hero_bg: 'linear-gradient(135deg, #034484 0%, #10b981 100%)',
        hero_image: '/assets/images/home/analytics.png',
        long_description: `
            <p>Data is only useful if you can understand it. Our Cloud SIEM (Security Information and Event Management) 
            aggregates logs from servers, firewalls, cloud services, and endpoints into a single searchable database.</p>
            <p>Using advanced machine learning, it correlates seemingly unrelated events to identify stealthy, multi-stage attacks 
            that traditional tools miss.</p>
        `,
        features: [
            { title: 'Universal Ingestion', desc: 'Accepts logs in Syslog, CEF, JSON, and custom formats.', icon: 'bi bi-funnel' },
            { title: 'Real-Time Correlation', desc: 'Rules engine detects complex attack patterns instantly.', icon: 'bi bi-diagram-2' },
            { title: 'Long-Term Retention', desc: 'Secure, cost-effective storage for compliance reporting.', icon: 'bi bi-archive' }
        ],
        benefits: [
            { title: 'Complete Visibility', description: 'No more checking logs across ten different consoles.', icon: 'bi bi-eye' },
            { title: 'Meet Compliance', description: 'Satisfy log retention requirements for PCI-DSS, HIPAA, etc.', icon: 'bi bi-file-check' },
            { title: 'Faster Investigations', description: 'Lightning-fast search makes hunting threats easy.', icon: 'bi bi-search' }
        ],
        process: [
            { step: '01', title: 'Collect', description: 'Agents and forwarders ship logs to the cloud.' },
            { step: '02', title: 'Parse', description: 'Logs are normalized into a standard schema.' },
            { step: '03', title: 'Analyze', description: 'Rules engine and AI look for anomalies.' }
        ],
        why_choose_us: {
            title: 'Next-Generation SIEM',
            image: '/assets/images/home/article2.png',
            points: [
                'Cloud-native architecture scales infinitely.',
                'Hundreds of pre-built parsing rules.',
                'Predictable pricing based on data ingested.'
            ]
        },
        faq: [
            { question: 'How long do you store logs?', answer: 'We offer 30-day hot storage and up to 7 years of cold storage for compliance.' },
            { question: 'Is it hard to set up?', answer: 'We provide out-of-the-box integrations for AWS, Azure, Windows, Linux, and major firewalls.' }
        ],
        content: ``
    },
    'defend': {
    ...
    'cloud-storage': {
        title: 'Secure Cloud Object Storage',
        subtitle: 'Planet-Scale Data Lakes',
        description: 'Infinitely scalable, highly durable, and compliant cloud storage for enterprise data.',
        icon: 'bi bi-cloud-arrow-up',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #3b82f6 100%)',
        hero_image: '/assets/images/home/search.png',
        long_description: `
            <p>Data is the lifeblood of the modern enterprise. But as your data grows exponentially, traditional storage arrays become cost-prohibitive 
            and difficult to manage. BitGuard Cloud Storage provides S3-compatible, ultra-durable storage that scales instantly without capital expenditure.</p>
            <p>Engineered for security from the ground up, all data is encrypted at rest (AES-256) and in transit. Object lock features ensure that 
            your critical backups remain immutable, providing a bulletproof defense against ransomware extortion.</p>
        `,
        features: [
            { title: '11 Nines of Durability', desc: 'Data is replicated across multiple availability zones automatically.', icon: 'bi bi-shield-lock' },
            { title: 'S3 Compatibility', desc: 'Plug and play with your existing backup tools like Veeam or Commvault.', icon: 'bi bi-plug-fill' },
            { title: 'Zero Egress Fees', desc: 'Predictable pricing. Never pay to retrieve your own data.', icon: 'bi bi-arrow-down-circle' }
        ],
        benefits: [
            { title: 'Ransomware Immunity', description: 'WORM (Write Once, Read Many) capability stops hackers dead.', icon: 'bi bi-x-octagon' },
            { title: 'Lower TCO', description: 'Eliminate hardware lifecycle management and forklift upgrades.', icon: 'bi bi-graph-down' },
            { title: 'Instant Scalability', description: 'Add petabytes of storage in seconds without buying hardware.', icon: 'bi bi-arrows-expand' }
        ],
        process: [
            { step: '01', title: 'Provision', description: 'Create buckets instantly via API or dashboard.' },
            { step: '02', title: 'Connect', description: 'Point your applications to our S3-compatible endpoints.' },
            { step: '03', title: 'Scale', description: 'Pay only for the gigabytes you actually chew.' }
        ],
        why_choose_us: {
            title: 'Storage Engineered for Security',
            points: [
                'Compliant with HIPAA, GDPR, and CJIS requirements.',
                'Data sovereignty guarantees (your data stays in your region).',
                'Native integration with BitGuard SIEM.'
            ]
        },
        faq: [
            { question: 'What is the performance (IOPS)?', answer: 'We offer standard and high-performance NVMe tiers for different workloads.' },
            { question: 'Is there a minimum commit?', answer: 'No, billing is strictly pay-as-you-go.' }
        ]
    },
    'web-design': {
        title: 'Digital Experience Design',
        subtitle: 'Enterprise Web Apps',
        description: 'High-performance web applications built for speed, conversion, and global scale.',
        icon: 'bi bi-window',
        hero_bg: 'linear-gradient(135deg, #020617 0%, #0891b2 100%)',
        hero_image: '/assets/images/home/api.png',
        long_description: `
            <p>A website is no longer just a brochure; it is a critical application that must be secure, accessible, and blindingly fast. 
            BitGuard's Digital Experience team architects corporate websites and portals that act as the secure front door to your business.</p>
            <p>Using modern frameworks (React, Next.js) and headless CMS architectures, we deliver 
            applications that score 100 on Google Lighthouse while maintaining military-grade security posture against OWASP Top 10 threats.</p>
        `,
        features: [
            { title: 'Edge Caching', desc: 'Content delivered instantly to global users via our worldwide CDN.', icon: 'bi bi-globe2' },
            { title: 'Headless Architecture', desc: 'Decoupled frontend and backend for ultimate security and speed.', icon: 'bi bi-boxes' },
            { title: 'WAF Integration', desc: 'Native Web Application Firewall protects against DDoS and injections.', icon: 'bi bi-shield-shaded' }
        ],
        benefits: [
            { title: 'SEO Dominance', description: 'Core Web Vitals optimization guarantees higher search rankings.', icon: 'bi bi-graph-up-arrow' },
            { title: 'Conversion Increase', description: 'Sub-second page loads drastically reduce bounce rates.', icon: 'bi bi-lightning-charge' },
            { title: 'Zero Defacement', description: 'Immutable deployments mean your site cannot be hacked or altered.', icon: 'bi bi-lock' }
        ],
        process: [
            { step: '01', title: 'Wireframe', description: 'UX/UI design focused on conversion funnels.' },
            { step: '02', title: 'Develop', description: 'Agile sprint-based coding with React/Next.js.' },
            { step: '03', title: 'Deploy', description: 'Zero-downtime deployment to secure edge nodes.' }
        ],
        why_choose_us: {
            title: 'Design Meets Defense',
            points: [
                'In-house UI/UX designers combined with security engineers.',
                'Code compiled to static assets for immutable security.',
                'Accessibility (WCAG 2.1 AA) compliant by default.'
            ]
        },
        faq: [
            { question: 'Do you use WordPress?', answer: 'We engineer secure headless architectures to avoid traditional CMS vulnerabilities.' },
            { question: 'Can you integrate with our CRM?', answer: 'Yes, we build secure, API-first integrations with Salesforce, HubSpot, etc.' }
        ]
    },
    'full-stack': {
        title: 'Full Stack Engineering',
        subtitle: 'Bespoke Software Solutions',
        description: 'End-to-end software development tailored to your deepest business logic.',
        icon: 'bi bi-code-slash',
        hero_bg: 'linear-gradient(135deg, #1e1b4b 0%, #6366f1 100%)',
        hero_image: '/assets/images/home/multilingual.png',
        long_description: `
            <p>Off-the-shelf software often forces you to change your business to fit the tool. Custom software allows the tool to fit your business. 
            Our Full Stack Engineering division builds proprietary software applications that give you a competitive edge.</p>
            <p>From complex data processing backends to intuitive consumer-facing mobile apps, we operate as an elite tactical extension of your 
            product team, delivering clean, documented, and secure code on time and on budget.</p>
        `,
        features: [
            { title: 'Microservices', desc: 'Scalable containerized architecture (Docker/Kubernetes).', icon: 'bi bi-box-seam' },
            { title: 'API-First', desc: 'REST and GraphQL APIs built for future interoperability.', icon: 'bi bi-braces' },
            { title: 'DevSecOps', desc: 'Security scanning integrated directly into the CI/CD pipeline.', icon: 'bi bi-infinity' }
        ],
        benefits: [
            { title: 'Own your IP', description: 'Retain 100% ownership of the source code and intellectual property.', icon: 'bi bi-c-circle' },
            { title: 'Scalability', description: 'Architected to handle millions of concurrent users.', icon: 'bi bi-graph-up' },
            { title: 'Compliance', description: 'Code built to satisfy PCI-DSS and SOC2 requirements from Day 1.', icon: 'bi bi-shield-check' }
        ],
        process: [
            { step: '01', title: 'Scope', description: 'Deep discovery and architecture planning.' },
            { step: '02', title: 'Sprint', description: 'Iterative 2-week development cycles.' },
            { step: '03', title: 'Ship', description: 'Continuous deployment with automated testing.' }
        ],
        why_choose_us: {
            title: 'Engineering Excellence',
            points: [
                'Zero offshore code. All engineers are vetted and certified.',
                'Rigorous peer review and automated QA testing.',
                'Focus on modern stacks (Node, Python, Go, React).'
            ]
        },
        faq: [
            { question: 'Who owns the code?', answer: 'You do. We transfer complete IP ownership upon project completion.' },
            { question: 'Do you offer maintenance?', answer: 'Yes, we provide ongoing SLA-backed support and feature iteration.' }
        ]
    },
    'staff-augmentation': {
        title: 'IT Staff Augmentation',
        subtitle: 'Elite Talent on Demand',
        description: 'Instantly scale your engineering or security team with certified experts.',
        icon: 'bi bi-people-fill',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #14b8a6 100%)',
        hero_image: '/assets/images/people/man2.jpg',
        long_description: `
            <p>Hiring top-tier tech talent is slow, expensive, and risky. When you have a critical project deadline or a sudden gap in your organization, 
            BitGuard's Staff Augmentation service injects highly skilled professionals directly into your workflow.</p>
            <p>Our engineers embed within your team, participate in your standups, and adopt your culture. You get the velocity of a seasoned employee 
            without the recruiter fees, benefits overhead, or long-term commitment.</p>
        `,
        features: [
            { title: 'Pre-Vetted Talent', desc: 'Engineers who have passed our rigorous internal technical and cultural barriers.', icon: 'bi bi-patch-check' },
            { title: 'Domain Expertise', desc: 'Specialists in Cybersecurity, Cloud Infra (AWS/Azure), and Data Science.', icon: 'bi bi-stars' },
            { title: 'Flexible Terms', description: 'Scale up or down smoothly. Commitments as short as 3 months.', icon: 'bi bi-sliders' }
        ],
        benefits: [
            { title: 'Time to Market', description: 'Kickstart projects in days instead of months.', icon: 'bi bi-rocket-takeoff' },
            { title: 'Cost Efficiency', description: 'Avoid the hidden costs of HR, benefits, and bad hires.', icon: 'bi bi-wallet2' },
            { title: 'Knowledge Transfer', description: 'Upskill your internal team by working alongside industry veterans.', icon: 'bi bi-mortarboard' }
        ],
        process: [
            { step: '01', title: 'Analyze', description: 'We identify your specific stack and culture needs.' },
            { step: '02', title: 'Match', description: 'We introduce you to candidates from our bench.' },
            { step: '03', title: 'Embed', description: 'The engineer integrates into your daily agile processes.' }
        ],
        why_choose_us: {
            title: 'Not Just Outsourcing',
            points: [
                'Our engineers have the full backing of the BitGuard SOC and architects.',
                'Seamless off-boarding with comprehensive documentation.',
                'Engineers operate in your time zone.'
            ]
        },
        faq: [
            { question: 'Can we hire the engineer full-time later?', answer: 'Yes, we offer contract-to-hire options.' },
            { question: 'What if they are not a good fit?', answer: 'We will replace the engineer within 48 hours, no questions asked.' }
        ]
    },
    'digital-transformation': {
        title: 'Digital Transformation',
        subtitle: 'Modernize Your Legacy',
        description: 'Strategic overhaul of outdated systems to accelerate growth.',
        icon: 'bi bi-arrow-repeat',
        hero_bg: 'linear-gradient(135deg, #020617 0%, #a855f7 100%)',
        hero_image: '/assets/images/home/unified.jpg',
        long_description: `
            <p>Many enterprises are handcuffed to legacy, on-premise systems that stifle innovation and pose massive security risks. 
            Digital transformation is the process of completely modernizing how your business uses technology to deliver value to customers.</p>
            <p>BitGuard acts as your strategic partner, mapping out a multi-year roadmap to migrate to the cloud, adopt SaaS applications, 
            and implement AI, all while ensuring business continuity and maintaining an unbreakable security posture.</p>
        `,
        features: [
            { title: 'Legacy Modernization', desc: 'Refactoring old monolithic apps into scalable microservices.', icon: 'bi bi-box-seam' },
            { title: 'Cloud Migration', desc: 'Lift-and-transfer or complete re-architecture to AWS/Azure.', icon: 'bi bi-cloud-arrow-up' },
            { title: 'Change Management', desc: 'Training staff and driving internal adoption of new technologies.', icon: 'bi bi-people' }
        ],
        benefits: [
            { title: 'Agility', description: 'Pivot your business model faster than your competitors.', icon: 'bi bi-lightning' },
            { title: 'Risk Reduction', description: 'Eliminate end-of-life hardware and unsupported software vulnerabilities.', icon: 'bi bi-shield-lock' },
            { title: 'Data Value', description: 'Unlock siloed data to run AI and advanced analytics.', icon: 'bi bi-graph-up' }
        ],
        process: [
            { step: '01', title: 'Audit', description: 'Evaluate Technical Debt across the enterprise.' },
            { step: '02', title: 'Roadmap', description: 'Deliver a phased modernization plan tied to ROI.' },
            { step: '03', title: 'Execute', description: 'Systematic migration with zero operational downtime.' }
        ],
        why_choose_us: {
            title: 'Security-First Transformation',
            points: [
                'We guarantee that your new cloud environment will be more secure than your legacy data center.',
                'Phased approach minimizes risk of "big bang" deployments.',
                'Experienced with highly regulated industries (Finance, Health, Gov).'
            ]
        },
        faq: [
            { question: 'How long does a transformation take?', answer: 'Enterprise transformations span 1-3 years, but we deliver ROI in 90-day increments.' },
            { question: 'Do you handle the training?', answer: 'Yes, user adoption is a core pillar of our methodology.' }
        ]
    },
    'workflow-automation': {
        title: 'Workflow Automation',
        subtitle: 'Eliminate the Mundane',
        description: 'Connect disjointed systems and automate repetitive tasks with AI.',
        icon: 'bi bi-diagram-3-fill',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #eab308 100%)',
        hero_image: '/assets/images/home/analytics.png',
        long_description: `
            <p>If your employees are manually copying data between spreadsheets, CRMs, and financial systems, you are losing money. 
            BitGuard Workflow Automation leverages API integrations and RPA (Robotic Process Automation) to eliminate "busywork."</p>
            <p>We build invisible bridges between your SaaS applications. When a contract is signed in DocuSign, an invoice is automatically 
            created in QuickBooks, the client is moved to "Onboarding" in Salesforce, and a Slack notification goes to the team—instantly.</p>
        `,
        features: [
            { title: 'API Integrations', desc: 'Deep custom coding to connect tools that do not natively talk to each other.', icon: 'bi bi-plug' },
            { title: 'AI enrichment', desc: 'Use AI to extract text from PDFs or summarize emails instantly within the flow.', icon: 'bi bi-robot' },
            { title: 'RPA Bots', desc: 'For legacy systems without APIs, our bots mimic human clicks and keystrokes.', icon: 'bi bi-cpu' }
        ],
        benefits: [
            { title: 'Zero Errors', description: 'Computers do not make typos during data entry.', icon: 'bi bi-check-circle' },
            { title: 'Scalability', description: 'Handle 10x the workload without adding administrative headcount.', icon: 'bi bi-arrows-angle-expand' },
            { title: 'Employee Joy', description: 'Free your staff to focus on high-value, creative problem-solving.', icon: 'bi bi-emoji-smile' }
        ],
        process: [
            { step: '01', title: 'Discover', description: 'Identify your most manual, time-consuming tasks.' },
            { step: '02', title: 'Build', description: 'Construct the logic gates and API connections.' },
            { step: '03', title: 'Test', description: 'Run the automation in sandbox before going live.' }
        ],
        why_choose_us: {
            title: 'Architects of Efficiency',
            points: [
                'Vendor agnostic: We work with Zapier, Make, Power Automate, and custom Python scripts.',
                'Secure credential handling via enterprise vaults, not plaintext.',
                'Detailed logging for all automated actions.'
            ]
        },
        faq: [
    ...
    'legal': {
        title: 'Legal & Professional Services IT',
        subtitle: 'Client Data Privacy',
        description: 'Enterprise-grade IT, cybersecurity, and compliance solutions purpose-built for law firms and professional services organizations.',
        icon: 'bi bi-briefcase-fill',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #4f46e5 100%)',
        long_description: '<p>Law firms and professional services organizations hold some of the most sensitive client data in the world. A single breach can trigger malpractice claims, bar association sanctions, and devastating reputational damage.</p><p>BitGuard provides end-to-end IT and cybersecurity services tailored to legal and professional environments — from secure document management and encrypted client portals to matter-based access controls and compliance with state bar data security guidelines. Our vCISO team ensures your firm meets ABA, HIPAA (for healthcare law), and GDPR requirements at every level.</p>'
    },
    'education': {
        title: 'Education & Non-Profit IT',
        subtitle: 'FERPA Compliant',
        description: 'Scalable, secure, and budget-conscious IT solutions for K-12 schools, universities, and non-profit organizations.',
        icon: 'bi bi-book-fill',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #7c3aed 100%)',
        long_description: '<p>Educational institutions face a unique challenge: protecting sensitive student records (FERPA) and faculty research with limited IT budgets, high device counts, and an open, collaborative campus culture that conflicts with strict security postures.</p><p>BitGuard delivers cost-effective managed IT, device management (MDM for Chromebooks, iPads, and Windows), Google Workspace and Microsoft 365 governance, and proactive threat monitoring specifically designed for education environments. We help institutions achieve FERPA and CIPA compliance without disrupting the learning experience.</p>'
    },
    'energy': {
        title: 'Energy & Utilities IT',
        subtitle: 'NERC CIP Compliant',
        description: 'Critical infrastructure protection and operational technology (OT) security for energy producers, utilities, and grid operators.',
        icon: 'bi bi-lightning-charge-fill',
        hero_bg: 'linear-gradient(135deg, #0f172a 0%, #ca8a04 100%)',
        long_description: '<p>The energy and utilities sector is a prime target for nation-state threat actors and ransomware groups. Operational Technology (OT) and Industrial Control Systems (ICS) that manage power grids, pipelines, and water treatment plants require specialized cybersecurity expertise far beyond standard IT security.</p><p>BitGuard provides NERC CIP compliance consulting, IT/OT network segmentation, SCADA system security assessments, and 24/7 SOC monitoring tuned for the energy sector. We protect the critical systems that keep the lights on and ensure continuity of operations even under active attack conditions.</p>'
    }
};

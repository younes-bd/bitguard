            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <Link to="/admin/payroll" className="text-emerald-400 text-sm hover:underline flex items-center gap-1 font-bold">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <Link to="/admin/recruitment" className="text-blue-400 text-sm hover:underline flex items-center gap-1 font-bold">

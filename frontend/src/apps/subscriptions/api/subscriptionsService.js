...
export const subscriptionsService = {
    ...
    getSubscription: async () => {
        const response = await client.get('subscriptions/subscriptions/current/');
        return response.data;
    },
    getSubscriptions: async (params = {}) => {
        const response = await client.get('subscriptions/subscriptions/', { params });
        return response.data?.results || response.data;
    },
    subscribe: async (planId, interval) => {
        const response = await client.post('subscriptions/subscriptions/', { plan_id: planId, interval });
        return response.data;
    },
    ...
    getInvoices: async (params = {}) => {
        const response = await client.get('subscriptions/invoices/', { params });
        return response.data?.results || response.data;
    }
};

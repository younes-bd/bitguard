...
const BillingAdminPage = () => {
    ...
    const loadData = async () => {
        try {
            const [p, s] = await Promise.all([
                ...
                subscriptionsService.getSubscription().catch(() => null),
            ]);
            setPlans(p);
            setSubscription(s);
        } catch (e) {
    ...
    const handleSubscribe = async (planId, interval) => {
        ...
        try {
            const { checkout_url } = await subscriptionsService.subscribe(planId, interval);
    ...
    const handlePause = async () => {
        ...
        try {
            await subscriptionsService.pauseSubscription(subscription.id);
            loadData();
        } catch (e) {

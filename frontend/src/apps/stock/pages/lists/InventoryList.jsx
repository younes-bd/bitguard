...
const InventoryList = () => {
    ...
    useEffect(() => {
        inventoryService.getInventoryItems({ search }).then(d => {
    ...
    const handleSave = async (formData) => {
        ...
        try {
            ...
            const data = await inventoryService.getInventoryItems({ search });
    ...
    const handleAdjustStock = async (e) => {
        ...
        setActionLoading(true);
        try {
            await inventoryService.adjustStock(adjustingItem.id, adjustFormData);

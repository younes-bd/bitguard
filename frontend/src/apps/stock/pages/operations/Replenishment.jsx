    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="glass-panel p-12 rounded-xl border border-slate-700/50 flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-xl font-bold text-white mb-2">Replenishment Module</h2>
                <p className="text-slate-400 max-w-md">Manage stock replenishment rules and operations.</p>
            </div>
        </div>
    );
};

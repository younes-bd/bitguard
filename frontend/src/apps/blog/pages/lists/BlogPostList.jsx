                        ...
                        <tbody className="divide-y divide-slate-800/50">
                            {posts.map(post => (
                                <tr key={post.id} className="hover:bg-slate-800/30 transition-colors group">
                                    ...
                                    <td className="p-4 text-slate-400 text-sm">{post.category || 'â€”'}</td>
                                    <td className="p-4">
                                    ...
                                    <td className="p-4 text-slate-400 text-sm">{post.published_date ? new Date(post.published_date).toLocaleDateString() : 'â€”'}</td>

    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button 
                    onClick={() => navigate('/admin/projects/list/create')}
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-3 mb-1">
                                    ...
                                    {project.is_service_obligation && (
                                        <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-indigo-500/10 text-indigo-400 border border-indigo-500/30">
                                            <ShoppingBag size={10} />
                                            Store Delivery
                                        </span>
                                    )}
                            ...
                            <div className="flex items-center gap-6 md:pr-4">
                                ...
                                <div className="text-right hidden sm:block">
                                    <p className="text-xs text-slate-500 uppercase font-medium">Days Left</p>
                                    <div className="flex items-center gap-2 justify-end mt-1 text-sm font-medium text-white">
                                        {project.days_remaining !== null ? `${project.days_remaining} days` : 'N/A'}
                                    </div>
                                </div>
                            </div>

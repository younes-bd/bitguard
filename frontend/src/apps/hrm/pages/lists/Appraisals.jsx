...
export default function Appraisals() {
    const [appraisals] = useState([
        { id: 1, employee: 'Alice Smith', manager: 'Robert Johnson', date: '2026-06-01', score: 4.8, status: 'Done' },
        { id: 2, employee: 'Bob Jones', manager: 'Alice Smith', date: '2026-06-15', score: null, status: 'Planned' },
        { id: 3, employee: 'Charlie Brown', manager: 'Alice Smith', date: '2026-06-20', score: null, status: 'In Progress' }
    ]);
                ...
                {appraisals.map(app => (
                    <div key={app.id} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative overflow-hidden group">
                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <h3 className="text-lg font-bold text-white">{app.employee}</h3>
                                <div className="text-sm text-slate-400">Reviewer: {app.manager}</div>
                            </div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-slate-300 mb-6">
                            <Calendar size={16} className="text-slate-500"/> {app.date}
                        </div>

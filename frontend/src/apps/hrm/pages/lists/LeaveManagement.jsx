                    ...
                    <div key={leave.id} className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button 
                                onClick={async () => {
                                    try {
                                        await reportingService.generateReport(null, 'hrm.LeaveRequest', leave.id);
                                        toast.success('Document downloaded');
                                    } catch(e) {
                                        toast.error('Failed to download document');
                                    }
                                }}
                                className="flex items-center gap-1 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors">

...
const PayrollDashboard = () => {
    ...
    useEffect(() => {
        Promise.all([
            ...
            const mappedRuns = periodsList.slice(0, 5).map(p => ({
                id: p.id,
                period: p.name,
                date: p.end_date,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-slate-900/50 backdrop-blur-md border border-slate-700/50 rounded-3xl overflow-hidden shadow-xl">
                    <div className="px-6 py-5 border-b border-slate-700/50 flex justify-between items-center bg-slate-800/30">
                        ...
                        <button onClick={() => navigate('/hrm/payroll')} className="text-xs font-bold text-indigo-400 hover:text-indigo-300 uppercase tracking-wider transition-colors flex items-center gap-1">

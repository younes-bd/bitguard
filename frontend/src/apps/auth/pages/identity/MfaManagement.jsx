...
const MfaManagement = () => {
    ...
    useEffect(() => {
        const checkMfaStatus = async () => {
            try {
                const response = await iamService.getUsers({ me: true });
    ...
    const handleStartSetup = async () => {
        setLoading(true);
        try {
            const data = await iamService.setupMfa();
            setSetupData(data);
            setStatus('verifying');
        } catch (error) {
    ...
    const handleVerify = async () => {
        ...
        setLoading(true);
        try {
            await iamService.verifyMfa(verificationToken);
    ...
    const handleDisable = async () => {
        ...
        try {
            ...
            await iamService.updateMe({ mfa_enabled: false });

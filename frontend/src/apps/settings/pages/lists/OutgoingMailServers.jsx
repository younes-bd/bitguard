...
export default function OutgoingMailServers() {
    ...
    const fetchServers = async () => {
        setLoading(true);
        try {
            const res = await client.get('base_setup/mail-servers-outgoing/');
    ...
    const handleSave = async () => {
        ...
        try {
            if (editingServer) {
                await client.patch(`base_setup/mail-servers-outgoing/${editingServer.id}/`, form);
                toast.success('Server updated');
            } else {
                await client.post('base_setup/mail-servers-outgoing/', form);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await client.delete(`base_setup/mail-servers-outgoing/${id}/`);
    ...
    const handleTest = async (id) => {
        setTestingId(id);
        try {
            const res = await client.post(`base_setup/mail-servers-outgoing/${id}/test/`);

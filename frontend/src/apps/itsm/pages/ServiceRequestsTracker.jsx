...
export default function ServiceRequestsTracker() {
    ...
    const fetchRequests = () => {
        setLoading(true);
        itsmService.getServiceRequests()
            .then(data => {
                setRequests(data);
            })
            .catch(err => {
    ...
    const handleApprove = async (id) => {
        ...
        try {
            await itsmService.approveServiceRequest(id);
            toast.success('IT Service Request approved successfully!');
            // Refresh detailed request
            const updated = await itsmService.getServiceRequest(id);
    ...
    const handleReject = async (id) => {
        setActionLoading(true);
        try {
            await itsmService.rejectServiceRequest(id);

...
export default function ShippingSettings() {
    ...
    const fetchZones = async () => {
        setLoading(true);
        try {
            const data = await storeService.getShippingSettings();
    ...
    const handleSave = async (formData) => {
        ...
        try {
            if (selectedItem) {
                await storeService.updateShippingSetting(selectedItem.id, formData);
                toast.success('Route configured');
            } else {
                await storeService.createShippingSetting(formData);
    ...
    const handleDelete = async () => {
        setActionLoading(true);
        try {
            await storeService.deleteShippingSetting(selectedItem.id);

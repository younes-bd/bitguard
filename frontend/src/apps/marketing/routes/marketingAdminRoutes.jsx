...
import SmsDashboard from '../../sms/pages/dashboards/SmsDashboard';
import SmsMailings from '../../sms/pages/features/SmsMailings';
import SmsContacts from '../../sms/pages/features/SmsContacts';
import SmsAnalytics from '../../sms/pages/features/SmsAnalytics';
import MassMailingPage from '../../mass_mailing/pages/MassMailingPage';
...
export const marketingAdminRoutes = (
    <>
        ...
        <Route path="sms/mailings" element={<SmsMailings />} />

            ...
            <section className="pb-24 dark:bg-slate-900 bg-white transition-colors duration-300">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="dark:text-slate-300 text-slate-700 space-y-8 leading-relaxed">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">6. Your General Rights</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">7. GDPR Lawful Basis for Processing</h2>
                            <p>If you are a resident of the European Economic Area (EEA), our lawful basis for collecting and using your personal data depends on the data concerned and the specific context in which we collect it. We normally collect personal data from you only where we have your consent to do so, where we need the personal data to perform a contract with you, or where the processing is in our legitimate interests and not overridden by your data protection interests or fundamental rights and freedoms.</p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">8. California Consumer Privacy Act (CCPA) Rights</h2>
                            <p>If you are a California resident, you have the right to request that we disclose certain information to you about our collection and use of your personal information over the past 12 months. You also have the right to request the deletion of your personal information. BitGuard does not sell your personal information. To exercise your rights, please submit a verifiable consumer request to <a href="mailto:privacy@bitguard.com" className="text-blue-600 dark:text-blue-400 hover:underline">privacy@bitguard.com</a>.</p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">9. Cookies</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">10. Changes to This Policy</h2>
                            <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date.</p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">11. Contact Us</h2>

            ...
            <section className="pb-24 dark:bg-slate-900 bg-white transition-colors duration-300">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="dark:text-slate-300 text-slate-700 space-y-8 leading-relaxed">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">6. Data Processing Agreement (DPA)</h2>
                            <p>To the extent that BitGuard processes any Personal Data (as defined in the GDPR) on your behalf in the provision of the Services, the terms of the BitGuard Data Processing Agreement ("DPA"), which are hereby incorporated by reference, shall apply and the parties agree to comply with such terms.</p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">7. Intellectual Property</h2>
                            <p>All content, features, and functionality of the Services â€” including but not limited to text, graphics, logos, and software â€” are the exclusive property of BitGuard Technologies LLC and are protected by copyright, trademark, and other intellectual property laws.</p>
                        </div>

                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">8. Limitation of Liability</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">9. Termination</h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-4">10. Governing Law</h2>

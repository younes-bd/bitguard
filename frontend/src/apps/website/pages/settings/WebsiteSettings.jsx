...
const WebsiteSettings = () => {
    ...
    const settingRows = [
        { key: 'website_google_analytics', label: 'Google Analytics', desc: 'Track visitors using Google Analytics.' },
        { key: 'website_live_chat', label: 'Live Chat', desc: 'Enable live chat widget on the website.' },
        { key: 'website_b2b_mode', label: 'B2B Mode', desc: 'Hide prices and require login to purchase.' },
        { key: 'website_seo_optimization', label: 'SEO Optimization', desc: 'Enable advanced SEO tools.' },
        { key: 'website_cookie_consent', label: 'Cookie Consent Bar', desc: 'Show cookie consent banner to visitors.' },
    ];
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto animate-fade-in-up">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-extrabold text-white tracking-tight font-['Oswald'] uppercase mb-2">Website Settings</h1>
                    <p className="text-slate-400">Configure SEO, Analytics, and eCommerce</p>
                </div>
            </div>

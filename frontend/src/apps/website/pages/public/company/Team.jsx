...
const Team = () => {
    return (
        <div className="dark:bg-slate-950 bg-slate-50 min-h-screen transition-colors duration-300">
            <PageMeta title="Our Team" description="Meet the experts behind BitGuard â€” engineers, analysts, and strategists dedicated to protecting your business." />
            {/* Dark Tech Hero */}
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        ...
                        <div className="group relative dark:bg-slate-800 bg-white rounded-2xl overflow-hidden shadow-xl border dark:border-slate-700 border-slate-100 hover:border-blue-200 dark:hover:border-blue-500 hover:shadow-2xl transition-all duration-500">
                            <div className="h-80 dark:bg-slate-900 bg-slate-100 relative overflow-hidden transition-colors duration-300">
                                ...
                                <div className="absolute inset-0 dark:bg-slate-900 bg-slate-200 transition-colors duration-300">
                                    <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80" alt="John Smith" className="w-full h-full object-cover object-top" />
                                </div>
                                {/* Tech Overlay */}
                                <div className="absolute inset-0 bg-blue-900/0 group-hover:bg-blue-900/60 transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 backdrop-blur-sm">
                                    <div className="flex gap-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <a href="https://www.linkedin.com/in/satyanadella/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-500 hover:text-white transition-colors shadow-lg">
                                            <i className="bi bi-linkedin text-xl"></i>
                                        </a>
                                        <a href="https://twitter.com/johnsmith_bg" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-sky-400 hover:bg-sky-500 hover:text-white transition-colors shadow-lg">
                            ...
                            <div className="p-8 relative">
                                ...
                                <p className="dark:text-slate-400 text-slate-600 leading-relaxed text-sm transition-colors duration-300 mb-4 h-16">
                                    Visionary leader with 20+ years of experience in cybersecurity and managed IT services. Prior NSA consultant.
                                </p>
                                {/* Certifications */}
                                <div className="flex flex-wrap gap-2 mt-auto">
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">CISSP</span>
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">CISM</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group relative dark:bg-slate-800 bg-white rounded-2xl overflow-hidden shadow-xl border dark:border-slate-700 border-slate-100 hover:border-indigo-200 dark:hover:border-indigo-500 hover:shadow-2xl transition-all duration-500">
                            <div className="h-80 dark:bg-slate-900 bg-slate-100 relative overflow-hidden transition-colors duration-300">
                                <div className="absolute inset-0 dark:bg-slate-900 bg-slate-200 transition-colors duration-300">
                                    <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80" alt="Jane Doe" className="w-full h-full object-cover object-top" />
                                </div>
                                <div className="absolute inset-0 bg-indigo-900/0 group-hover:bg-indigo-900/60 transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 backdrop-blur-sm">
                                    <div className="flex gap-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <a href="https://www.linkedin.com/in/sundarpichai/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-500 hover:text-white transition-colors shadow-lg">
                                            <i className="bi bi-linkedin text-xl"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="p-8 relative">
                                ...
                                <div className="flex flex-wrap gap-2 mt-auto">
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">AWS Solutions Architect</span>
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">Azure Administrator</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group relative dark:bg-slate-800 bg-white rounded-2xl overflow-hidden shadow-xl border dark:border-slate-700 border-slate-100 hover:border-emerald-200 dark:hover:border-emerald-500 hover:shadow-2xl transition-all duration-500">
                            <div className="h-80 dark:bg-slate-900 bg-slate-100 relative overflow-hidden transition-colors duration-300">
                                <div className="absolute inset-0 dark:bg-slate-900 bg-slate-200 transition-colors duration-300">
                                    <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=400&q=80" alt="Mike Johnson" className="w-full h-full object-cover object-top" />
                                </div>
                                <div className="absolute inset-0 bg-emerald-900/0 group-hover:bg-emerald-900/60 transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100 backdrop-blur-sm">
                                    <div className="flex gap-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <a href="https://www.linkedin.com/in/tim-cook/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-600 hover:bg-blue-500 hover:text-white transition-colors shadow-lg">
                                            <i className="bi bi-linkedin text-xl"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="p-8 relative">
                                ...
                                <p className="dark:text-slate-400 text-slate-600 leading-relaxed text-sm transition-colors duration-300 mb-4 h-16">
                                    Leads our SOC team, ensuring 24/7 monitoring and rapid incident response.
                                </p>
                                <div className="flex flex-wrap gap-2 mt-auto">
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">CISSP</span>
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">CEH</span>
                                    <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">Security+</span>
                                </div>
                            </div>
                        </div>
                    </div>

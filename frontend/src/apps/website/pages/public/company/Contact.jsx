...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus('success');
            setFormData({ fullName: '', email: '', department: '', subject: '', message: '' });
        } catch (error) {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        <div className="lg:col-span-2 dark:bg-slate-900 bg-white dark:text-white text-slate-900 rounded-xl p-10 shadow-xl border dark:border-slate-800 border-slate-200 relative overflow-hidden transition-colors duration-300">
                            ...
                            <div className="mt-16 pt-8 border-t dark:border-slate-800 border-slate-200 flex gap-4 transition-colors duration-300">
                                <a href="https://linkedin.com/company/bitguard" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full dark:bg-slate-800 bg-slate-100 flex items-center justify-center dark:text-slate-400 text-slate-500 hover:bg-blue-600 hover:text-white transition-all">
                                    <i className="bi bi-linkedin"></i>
                                </a>
                                <a href="https://twitter.com/bitguard" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full dark:bg-slate-800 bg-slate-100 flex items-center justify-center dark:text-slate-400 text-slate-500 hover:bg-blue-400 hover:text-white transition-all">
                                    <i className="bi bi-twitter-x"></i>
                                </a>
                                <a href="https://github.com/bitguard" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full dark:bg-slate-800 bg-slate-100 flex items-center justify-center dark:text-slate-400 text-slate-500 hover:bg-indigo-600 hover:text-white transition-all">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="relative">
                                        <select 
                                            ...
                                            className="peer w-full border-b-2 dark:border-slate-700 border-slate-200 py-3 dark:text-white text-slate-900 focus:border-blue-600 bg-transparent focus:outline-none transition-colors appearance-none"
                                            id="department" 
                                            required
                                        >
                                            <option value="" disabled className="dark:bg-slate-800 text-slate-500">Select Department</option>
                                            <option value="Sales" className="dark:bg-slate-800">Sales & Enterprise Solutions</option>
                                            <option value="Support" className="dark:bg-slate-800">Technical Support</option>
                                            <option value="Billing" className="dark:bg-slate-800">Billing & Accounting</option>
                                            <option value="General" className="dark:bg-slate-800">General Inquiry</option>
                                        </select>
                                        <label htmlFor="department" className="absolute left-0 -top-3.5 text-sm font-bold text-blue-600 transition-all">
                                            Department
                                        </label>
                                ...
                                <div className="pt-4">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center gap-6 justify-between">
                                        ...
                                        <div className="text-sm dark:text-slate-400 text-slate-500">
                                            <i className="bi bi-clock-history mr-2 text-blue-500"></i>
                                            We respond within 24 hours. Critical issues: <strong className="text-blue-500 dark:text-blue-400">15m response</strong>.
                                        </div>
                                    </div>
                                    <p className="dark:text-slate-400 text-slate-500 text-xs mt-6 text-center md:text-left">By submitting this form, you agree to our <Link to="/privacy" className="text-blue-600 dark:text-blue-400 hover:underline">Privacy Policy</Link>.</p>
                                </div>
                            </form>
                        </div>
                    </div>

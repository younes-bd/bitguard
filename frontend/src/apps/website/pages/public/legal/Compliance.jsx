...
const Compliance = () => {
    const standards = [
        ...
        },
        {
            ...
            desc: "Provide a standardized approach to security assessment, authorization, and continuous monitoring for cloud products.",
            icon: "bi bi-bank",
        ...
        },
        {
            ...
            desc: "Protect Federal Contract Information (FCI) and Controlled Unclassified Information (CUI) within the Defense Industrial Base.",
    ...
    return (
        <div className="dark:bg-slate-950 bg-slate-50 min-h-screen transition-colors duration-300">
            ...
            <section className="relative pt-32 pb-20 dark:bg-slate-950 bg-slate-950 overflow-hidden transition-colors duration-300">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link to="/security" className="px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold rounded-full transition-colors inline-flex items-center gap-2 shadow-lg backdrop-blur-sm no-underline">
                            <i className="bi bi-file-earmark-pdf-fill text-blue-400"></i>
            ...
            <section className="py-20 dark:bg-slate-900 bg-slate-50 transition-colors duration-300">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <h2 className="text-3xl font-bold dark:text-white text-slate-900 mb-6 transition-colors duration-300">Why Compliance Matters</h2>
                        <p className="dark:text-slate-400 text-slate-600 text-lg transition-colors duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {standards.map((std, i) => (
                            <div key={i} className="dark:bg-slate-800 bg-white rounded-2xl shadow-sm border dark:border-slate-700 border-slate-100 p-8 hover:shadow-xl dark:hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300">
                                <div className={`w-14 h-14 rounded-xl ${std.bg} ${std.color} flex items-center justify-center text-3xl mb-6`}>
                                    <i className={std.icon}></i>
                                </div>
                                <h3 className="text-xl font-bold dark:text-white text-slate-900 mb-1 transition-colors duration-300">{std.title}</h3>
                                <div className="text-xs font-bold dark:text-slate-500 text-slate-500 uppercase tracking-widest mb-4 transition-colors duration-300">{std.subtitle}</div>
                                <p className="dark:text-slate-300 text-slate-600 leading-relaxed transition-colors duration-300">{std.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Process Section â€” DARK for alternation */}
            <section className="py-20 dark:bg-slate-950 bg-slate-900 text-white relative overflow-hidden transition-colors duration-300">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-white mb-4 tracking-tight">Our Compliance Framework</h2>
                        <p className="text-slate-400">A proven 3-step path to audit readiness.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        {/* Connecting Line (Desktop) */}
                        <div className="hidden md:block absolute top-12 left-[20%] right-[20%] h-1 bg-slate-800 -z-10"></div>
                        ...
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center text-center p-4">
                                <div className="w-24 h-24 rounded-full bg-blue-600 text-white flex items-center justify-center text-2xl font-bold mb-6 border-8 border-slate-950 shadow-lg shadow-blue-600/30">
                                    {item.step}
                                </div>
            ...
            {/* CTA â€” LIGHT for alternation */}
            <section className="py-24 dark:bg-slate-900 bg-white text-center transition-colors duration-300">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-4xl font-bold dark:text-white text-slate-900 mb-8 tracking-tight transition-colors duration-300">Ready to Prove Your Security?</h2>
                    <p className="dark:text-slate-400 text-slate-600 max-w-xl mx-auto mb-10 text-lg leading-relaxed transition-colors duration-300">Let us guide you through the entire compliance journey â€” from gap analysis to certification.</p>
                    <div className="flex flex-col md:flex-row justify-center gap-6">
                        <Link to="/contact" className="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-500 transition-colors no-underline shadow-lg shadow-blue-600/30">
                            Get Audit Ready
                        </Link>
                        <Link to="/security" className="px-8 py-4 border-2 dark:border-slate-700 border-slate-900 dark:text-slate-300 text-slate-900 font-bold rounded-xl dark:hover:bg-slate-800 dark:hover:text-white hover:bg-slate-900 hover:text-white transition-colors no-underline duration-300">
                            Download Compliance Report
                        </Link>
                    </div>
                </div>

...
const Podcasts = () => {
    ...
    return (
        <div className="dark:bg-slate-950 bg-slate-50 min-h-screen dark:text-slate-300 text-slate-600 font-sans transition-colors duration-300">
            <PageMeta title="Podcasts" description="Listen to BitGuard Tech Talks â€” weekly conversations with cybersecurity leaders, innovators, and white-hat hackers." />
            {/* Hero */}
            <section className="relative pt-32 pb-20 overflow-hidden transition-colors duration-300">
                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4">
                        <a href="#" onClick={(e) => e.preventDefault()} className="px-6 py-3 rounded-full bg-[#1db954] text-white font-bold hover:brightness-110 transition-all flex items-center gap-2 no-underline">
                            <i className="bi bi-spotify"></i> Soon on Spotify
                        </a>
                        <a href="#" onClick={(e) => e.preventDefault()} className="px-6 py-3 rounded-full bg-[#8e24aa] text-white font-bold hover:brightness-110 transition-all flex items-center gap-2 no-underline">
                            <i className="bi bi-apple"></i> Soon on Apple
                        </a>
                    </div>
                </div>
            </section>
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="flex gap-4">
                                    <button 
                                        ...
                                        className={`text-sm font-bold px-4 py-2 rounded-lg transition-colors duration-300 ${playingId === ep.id ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'dark:text-white text-slate-900 dark:bg-slate-800 bg-slate-100 dark:hover:bg-slate-700 hover:bg-slate-200'}`}
                                    >
                                        <i className={`bi ${playingId === ep.id ? 'bi-pause-fill' : 'bi-play-fill'} mr-1`}></i> {playingId === ep.id ? 'Playing...' : 'Play Episode'}
                                    </button>
            ...
            <section className="py-24 dark:bg-slate-950 bg-slate-900 text-white text-center relative overflow-hidden transition-colors duration-300">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <a href="#" onClick={(e) => e.preventDefault()} className="px-6 py-3 rounded-xl bg-[#1db954] text-white font-bold hover:brightness-110 transition-all flex items-center gap-2 shadow-lg no-underline">
                            <i className="bi bi-spotify"></i> Spotify
                        </a>
                        <a href="#" onClick={(e) => e.preventDefault()} className="px-6 py-3 rounded-xl bg-[#8e24aa] text-white font-bold hover:brightness-110 transition-all flex items-center gap-2 shadow-lg no-underline">
                            <i className="bi bi-apple"></i> Apple Podcasts
                        </a>
                        <a href="#" onClick={(e) => e.preventDefault()} className="px-6 py-3 rounded-xl dark:bg-slate-800 bg-slate-700 text-white font-bold dark:hover:bg-slate-700 hover:bg-slate-600 transition-all flex items-center gap-2 duration-300 no-underline">

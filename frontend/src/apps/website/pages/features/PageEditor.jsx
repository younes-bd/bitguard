            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-6 shadow-xl relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row gap-8 relative z-10">
                    ...
                    <div className="md:w-2/3 space-y-5">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-slate-300 ml-1">Assign to Website</label>
                            <select
                                name="website"
                                value={formData.website || ''}
                                onChange={handleChange}
                                className="w-full bg-slate-950/50 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all font-medium"
                            >
                                <option value="">-- No Website Assigned (Global) --</option>
                                {websites.map(site => (

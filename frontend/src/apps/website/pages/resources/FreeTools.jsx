...
const FreeTools = () => {
    ...
    return (
        <div className="dark:bg-slate-950 bg-slate-50 min-h-screen transition-colors duration-300">
            <PageMeta title="Free IT Tools" description="Free IT calculators and security tools from BitGuard — ROI calculator and password strength checker." />
            {/* Hero */}
                ...
                <div className="dark:bg-slate-800 bg-white rounded-2xl shadow-xl border dark:border-slate-700 border-slate-100 p-8 transition-colors duration-300">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-6 border-t dark:border-slate-700 border-slate-100 transition-colors duration-300">
                            ...
                            <p className="text-xs dark:text-slate-500 text-slate-400 mt-4 text-center transition-colors duration-300">
                                Based on industry average of 60% downtime reduction with proactive monitoring.*
                                <span className="block mt-1 text-[10px] opacity-70">*Source: 2025 Gartner IT Key Metrics Data.</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-4 pr-12 dark:bg-slate-900 bg-slate-50 border dark:border-slate-600 border-slate-200 rounded-xl focus:outline-none focus:border-indigo-500 dark:text-white text-slate-900 text-lg transition-colors duration-300"
                            />
                            <button
                                type="button"

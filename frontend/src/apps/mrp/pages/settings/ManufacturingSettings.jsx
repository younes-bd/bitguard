...
const ManufacturingSettings = () => {
    ...
    const settingRows = [
        { key: 'mrp_work_orders', label: 'Work Orders', desc: 'Process operations at specific work centers.' },
        { key: 'mrp_subcontracting', label: 'Subcontracting', desc: 'Subcontract the production of some products.' },
        { key: 'mrp_byproducts', label: 'By-Products', desc: 'Produce residual products from manufacturing.' },
        { key: 'mrp_master_production_schedule', label: 'Master Production Schedule', desc: 'Plan your manufacturing based on forecasts.' },
        { key: 'mrp_security_lead_time', label: 'Security Lead Time', desc: 'Schedule manufacturing orders earlier to avoid delays (days).' },
    ];
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto animate-fade-in-up">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-extrabold text-white tracking-tight font-['Oswald'] uppercase mb-2">Manufacturing Settings</h1>
                    <p className="text-slate-400">Configure BOMs, Work Orders, and Quality Control</p>
                </div>
            </div>

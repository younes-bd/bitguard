...
export default function WorkspaceManager() {
    ...
    const fetchWorkspaces = async () => {
        setLoading(true);
        try {
            const res = await edmsService.getWorkspaces();
    ...
    const handleCreate = async (e) => {
        e.preventDefault();
        try {
            await edmsService.createWorkspace({ name, description });
            setName('');
            setDescription('');
            fetchWorkspaces();
        } catch (err) {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await edmsService.deleteWorkspace(id);
            fetchWorkspaces();
        } catch (err) {
    ...
    const handleUpdate = async (id) => {
        try {
            await edmsService.updateWorkspace(id, { name: editName, description: editDescription });
            setEditingId(null);
            fetchWorkspaces();
        } catch (err) {

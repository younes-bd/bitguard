...
// A generic functional component for ElearningSettings
export default function ElearningSettings() {
    ...
    useEffect(() => {
        setLoading(true);
        elearningService.getElearningSettings()
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-white font-['Oswald'] tracking-wider uppercase flex items-center gap-3">
                        <LayoutDashboard className="text-sky-400" size={28} /> eLearning Settings
                    </h1>
                    <p className="text-slate-400 text-sm mt-0.5">Manage elearning settings configurations</p>
                </div>
                <button 

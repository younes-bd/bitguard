...
const TicketDetails = () => {
    ...
    return (
        <div className="p-6 lg:p-8 space-y-6 animate-in fade-in duration-400">
            <button onClick={() => navigate('/admin/helpdesk/tickets')} className="text-slate-400 hover:text-white flex items-center gap-2 mb-4">
                            ...
                            <div className="flex gap-3">
                                {ticket.status === 'resolved' && (
                                    <button 
                                        onClick={async () => {
                                            try {
                                                await helpdeskService.createKbFromTicket(ticket.id);
                                ...
                                <button onClick={() => {
                                    ...
                                    if (id) {
                                        helpdeskService.linkArticle(ticket.id, id)

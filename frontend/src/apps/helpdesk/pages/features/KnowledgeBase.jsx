...
const KnowledgeBase = () => {
    ...
    const handleSave = async (formData) => {
        ...
        try {
            if (selectedArticle) {
                await helpdeskService.updateArticle(selectedArticle.id, formData);
            } else {
                await helpdeskService.createArticle(formData);
            }
    ...
    const handleDelete = async () => {
        ...
        setActionLoading(true);
        try {
            await helpdeskService.deleteArticle(selectedArticle.id);

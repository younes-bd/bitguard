                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-4 mt-2 text-sm text-slate-400">
                        ...
                        {incident.external_event_id && (
                            <span className="flex items-center gap-1 px-2 py-0.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 rounded font-mono text-[10px]">
                                SIEM ID: {incident.external_event_id}
                            </span>
                        )}
                    </div>
                </div>
                    ...
                    <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                            <button 
                                onClick={async () => {
                                    try {
                                        await reportingService.generateReport(null, 'soc.Incident', incident.id);
                                ...
                                className="w-full py-2 px-4 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-colors font-medium flex items-center justify-center gap-2"
                            >

...
import {
    ...
    FileSpreadsheet, ShieldCheck as ShieldCheck2, Award, Smartphone, FileQuestion, MessageCircle, Book, PhoneCall
} from 'lucide-react';
...
const CommandCenter = () => {
    ...
    const kpiCards = [
        ...
        },
        {
            ...
            sub: 'Subscriptions',
            icon: Activity, color: 'indigo', to: '/admin/analytics/mrr',
        },
        {
    ...
    const enterprisePillars = [
        ...
        },
        {
            ...
            tiles: [
                ...
                { title: 'IT Service Desk (Helpdesk)', path: '/admin/helpdesk', icon: LifeBuoy, color: 'amber', kpi: metrics.support?.open_tickets, kpiLabel: 'open tickets', status: 'active' },
                { title: 'Change Management (Planning)', path: '/admin/services', icon: Tag, color: 'purple', kpi: metrics.services?.requests, kpiLabel: 'requests', status: 'active' },
            ]
        },
        {
            name: 'Accounting',
            ...
            tiles: [
                ...
                { title: 'Spreadsheet', path: '/admin/spreadsheet', icon: FileSpreadsheet, color: 'emerald', kpi: undefined, kpiLabel: '', status: 'active' },
            ]
        },
        {
            name: 'Inventory & MRP',
            icon: Box,
            tiles: [
                { title: 'Inventory', path: '/admin/inventory', icon: Box, color: 'orange', kpi: metrics.inventory?.low_stock_items, kpiLabel: 'low stock', status: (metrics.inventory?.low_stock_items > 0) ? 'warning' : 'active' },
                ...
                { title: 'Maintenance', path: '/admin/assets', icon: Monitor, color: 'cyan', kpi: metrics.assets?.total_assets, kpiLabel: 'assets', status: 'active' },
                { title: 'Quality', path: '/admin/quality', icon: ShieldCheck2, color: 'emerald', kpi: undefined, kpiLabel: '', status: 'active' },
                { title: 'PLM', path: '/admin/plm', icon: Layers, color: 'blue', kpi: undefined, kpiLabel: '', status: 'active' },
            ]
        },
        {
            ...
            icon: Users,
            tiles: [
                { title: 'Employees', path: '/admin/hrm', icon: Building2, color: 'pink', kpi: metrics.hrm?.headcount, kpiLabel: 'employees', status: (metrics.hrm?.headcount > 0) ? 'active' : 'idle' },
                ...
                { title: 'Time Off', path: '/admin/timeoff', icon: Clock, color: 'blue', kpi: metrics.hrm?.pending_timeoff, kpiLabel: 'to approve', status: 'active' },
        ...
        },
        {
            ...
            tiles: [
                ...
                { title: 'Email Marketing', path: '/admin/email-marketing', icon: Mail, color: 'indigo', kpi: undefined, kpiLabel: '', status: 'active' },
        ...
        },
        {
            ...
            icon: Globe,
            tiles: [
                { title: 'Website', path: '/admin/cms', icon: Globe, color: 'sky', kpi: metrics.cms?.pages, kpiLabel: 'pages', status: 'active' },
                { title: 'eCommerce', path: '/admin/store', icon: ShoppingBag, color: 'emerald', kpi: undefined, kpiLabel: '', status: 'active' },
        ...
        },
        {
            ...
            icon: Calendar,
            tiles: [
                { title: 'Documents', path: '/admin/edms', icon: FolderOpen, color: 'cyan', kpi: metrics.documents?.total, kpiLabel: 'documents', status: 'active' },
        ...
        },
        {
            ...
            tiles: [
                ...
                { title: 'Users & Companies', path: '/admin/iam', icon: Key, color: 'violet', kpi: metrics.iam?.users, kpiLabel: 'users', status: 'active' },
                { title: 'Enterprise Analytics (Dashboards)', path: '/admin/analytics', icon: BarChart3, color: 'indigo', kpi: undefined, kpiLabel: '', status: 'active' },
                { title: 'Settings', path: '/admin/system', icon: Server, color: 'slate', kpi: undefined, kpiLabel: '', status: 'active' },
                { title: 'Apps', path: '/admin/system/apps', icon: Layers, color: 'cyan', kpi: undefined, kpiLabel: '', status: 'active' },
            ]
        }
    ];
    ...
    const renderNeedsAttention = () => {
        ...
        if (metrics.services?.high_risk > 0) issues.push({ text: `${metrics.services.high_risk} High-Risk Changes`, to: '/admin/services', actionLabel: 'Approve' });
        ...
        if (metrics.documents?.expiring_soon > 0)
            issues.push({ text: `${metrics.documents.expiring_soon} Documents Expiring This Week`, to: '/admin/edms', actionLabel: 'Renew' });
        if (metrics.assets?.expiring_licenses > 0)
            issues.push({ text: `${metrics.assets.expiring_licenses} Software Licenses Expiring`, to: '/admin/assets/licenses', actionLabel: 'Renew' });

...
describe('CommandCenter Dashboard', () => {
    ...
    it('renders the loading state initially', () => {
        dashboardService.getMetrics.mockReturnValue(new Promise(() => {})); // pending promise
        dashboardService.getSystemHealth.mockReturnValue(new Promise(() => {}));
        dashboardService.getRecentActivity.mockReturnValue(new Promise(() => {}));
        render(
            <BrowserRouter>
                <CommandCenter />
            </BrowserRouter>
    ...
    it('renders the dashboard with KPI cards and Needs Attention widgets', async () => {
        ...
        dashboardService.getSystemHealth.mockResolvedValue({ status: 'healthy', active_nodes: 5, load_avg: '0.45' });
    ...
    it('handles API errors gracefully', async () => {
        dashboardService.getMetrics.mockRejectedValue(new Error('Failed to fetch metrics'));
        dashboardService.getSystemHealth.mockResolvedValue({});
        dashboardService.getRecentActivity.mockResolvedValue([]);

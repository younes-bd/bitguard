...
const ProformaInvoiceTemplate = ({ data }) => {
    ...
    const depositRequired = total * 0.50; // 50% deposit
        ...
        <div className="p-12 relative h-full flex flex-col">
            ...
            <div className="flex justify-between items-start mb-12">
                ...
                <div className="text-right">
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase">Proforma Invoice</h1>
                    <div className="mt-4 inline-block bg-amber-100 text-amber-800 px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">
                        Awaiting Deposit
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-12 mb-12 border-y border-slate-200 py-6">
                ...
                <div className="text-right space-y-2">
                    <div className="flex justify-between w-48 ml-auto">
                        ...
                        <span className="text-sm font-semibold text-slate-900">PF-{data.meta.docNumber.split('-')[1]}</span>
                    </div>
                    <div className="flex justify-between w-48 ml-auto">
                    ...
                    <div className="flex justify-between w-48 ml-auto">
                        <span className="text-sm font-bold text-slate-400 uppercase">Terms</span>
                        <span className="text-sm font-semibold text-slate-900">50% Advance</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between items-start break-inside-avoid">
                <div className="w-1/2 pr-8">
                    <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                        ...
                        <p className="text-xs text-slate-600 font-medium">Account Name: BitGuard Solutions LLC</p>
                ...
                <div className="w-1/2">
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-lg bg-slate-900 text-white rounded-lg p-3 mt-4 items-center">
                            <span className="font-bold text-sm uppercase tracking-wider">Deposit Required</span>
                            <span className="font-black text-xl text-emerald-400">{formatCurrency(depositRequired)}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Footer */}
            <div className="mt-auto pt-8 text-center border-t border-slate-200 mt-12">
                <p className="text-xs text-slate-500 font-medium uppercase tracking-widest">Thank you for your business.</p>
            </div>
        </div>
    );
};

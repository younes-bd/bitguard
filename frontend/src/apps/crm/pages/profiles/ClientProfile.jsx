            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex gap-3">
                    <button 
                        ...
                        className="rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 dark:border-slate-700 dark:text-blue-400 dark:hover:bg-slate-800 flex items-center gap-2"
                        title="Download Client Statement PDF"
                    >

...
const AssetList = () => {
    ...
    const fetchAssets = () => {
        setLoading(true);
        maintenanceService.getAssets({ type: typeFilter || undefined, status: statusFilter || undefined })
    ...
    const handleSave = async (formData) => {
        ...
        try {
            if (selectedAsset) {
                await maintenanceService.updateAsset(selectedAsset.id, formData);
            } else {
                await maintenanceService.createAsset(formData);
            }
    ...
    const handleDelete = async () => {
        ...
        setActionLoading(true);
        try {
            await maintenanceService.deleteAsset(selectedAsset.id);

  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-20 animate-in fade-in duration-500">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <button onClick={() => navigate('/admin/erp/quotations')} className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
        ...
        <div className="flex flex-wrap gap-2">
          {isActive && (
            <>
              <button
                onClick={() => handleAction(() => erpService.convertQuotationToInvoice(id), 'Converted to Invoice!')}
              ...
              <button
                onClick={() => handleAction(() => erpService.declineQuotation(id), 'Quotation declined.')}
                disabled={actionLoading}
          ...
          <button
            onClick={() => erpService.downloadInvoice(id)}
          ...
          <button
            onClick={() => handleAction(() => erpService.sendInvoiceToClient(id), 'Quotation dispatched to client!')}
            disabled={actionLoading}

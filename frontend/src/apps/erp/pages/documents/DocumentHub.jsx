...
const documentTypes = [
  {
    ...
    listPath: '/admin/erp/invoices',
    createPath: '/admin/erp/invoices/create',
    accentColor: '#3b82f6',
  },
  {
    id: 'quotations',
    ...
    listPath: '/admin/erp/quotations',
    createPath: '/admin/erp/quotations/create',
    accentColor: '#a855f7',
  },
  {
    id: 'receipts',
    ...
    listPath: '/admin/erp/receipts',
    createPath: '/admin/erp/receipts/create',
    accentColor: '#10b981',
  },
  {
    id: 'proformas',
    ...
    listPath: '/admin/erp/invoices?type=proforma',
    createPath: '/admin/erp/invoices/create?type=proforma',
    accentColor: '#f97316',
  },
  {
    id: 'delivery',
    ...
    listPath: '/admin/erp/delivery',
    createPath: '/admin/erp/delivery/create',
    accentColor: '#06b6d4',
  },
  {
    id: 'purchase-orders',
    ...
    listPath: '/admin/erp/purchase-orders',
    createPath: '/admin/erp/purchase-orders/create',
    accentColor: '#eab308',
  },
  {
    id: 'credit-notes',
    ...
    listPath: '/admin/erp/credit-notes',
    createPath: '/admin/erp/credit-notes/create',
    accentColor: '#ef4444',
  },
];

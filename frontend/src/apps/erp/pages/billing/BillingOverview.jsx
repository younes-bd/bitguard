        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => navigate('/admin/erp/profit-loss')}
                ...
                <div className="lg:col-span-2 glass-panel rounded-2xl border border-slate-700/50 overflow-hidden">
                    ...
                    {invoices.length === 0 ? (
                        <div className="p-12 text-center text-slate-500">
                            ...
                            <p>No invoices yet. <button onClick={() => navigate('/admin/erp/invoices/create')} className="text-blue-400 hover:underline">Create one →</button></p>
                        </div>
                    ) : (
                ...
                <div className="space-y-4">
                    <div className="glass-panel p-6 rounded-2xl border border-slate-700/50">
                        ...
                        <div className="space-y-1">
                            <ReportButton title="Profit & Loss" onClick={() => navigate('/admin/erp/profit-loss')} icon={<TrendingUp size={18} />} />
                            <ReportButton title="Balance Sheet" onClick={() => navigate('/admin/erp/balance-sheet')} icon={<BarChart2 size={18} />} />
                            <ReportButton title="Cash Flow" onClick={() => navigate('/admin/erp/cash-flow')} icon={<Activity size={18} />} />
                            <ReportButton title="A/R Aging" onClick={() => navigate('/admin/erp/aging-report')} icon={<Clock size={18} />} />
                            <ReportButton title="Budget vs Actual" onClick={() => navigate('/admin/erp/budget-report')} icon={<CreditCard size={18} />} />
                        </div>
                    </div>

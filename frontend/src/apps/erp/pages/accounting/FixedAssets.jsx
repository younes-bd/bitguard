...
const FixedAssets = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setSaving(true);
        try {
            await erpService.createFixedAsset(formData);
    ...
    const handleRunDepreciation = async () => {
        setRunning(true);
        try {
            const result = await erpService.runDepreciation();
            toast.success(`Depreciation run complete — ${result.assets_processed} assets processed`);

        ...
        <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500">
                        ...
                        <button key={i} className="w-full flex items-center justify-between p-4 md:p-6 hover:bg-slate-800/50 transition-colors text-left group">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-slate-500">{new Date(log.timestamp).toLocaleString()} â€¢ {log.ip_address}</div>
                                </div>
                            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-slate-800">
                    ...
                    <p className="text-sm text-slate-400 mt-1">Where youâ€™re signed in.</p>
                </div>
                <div className="divide-y divide-slate-800">

...
export default function ShippingSettings() {
    ...
    const fetchZones = async () => {
        setLoading(true);
        try {
            const data = await ecommerceService.getShippingSettings();
    ...
    const handleSave = async (formData) => {
        ...
        try {
            if (selectedItem) {
                await ecommerceService.updateShippingSetting(selectedItem.id, formData);
                toast.success('Route configured');
            } else {
                await ecommerceService.createShippingSetting(formData);
    ...
    const handleDelete = async () => {
        setActionLoading(true);
        try {
            await ecommerceService.deleteShippingSetting(selectedItem.id);

...
const ProductDetail = () => {
    ...
    const handleCheckout = async () => {
        if (!product) return;
        try {
            const result = await ecommerceService.checkout(product.id, {
    ...
    if (!product) {
        return (
            <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col items-center justify-center text-center px-6">
                ...
                <Link to="/ecommerce" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">
                    ← Back to Catalog
                </Link>
            </div>
        );
        ...
        <div className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <Link to="/ecommerce" className="inline-flex items-center gap-2 text-sm text-indigo-600 dark:text-indigo-400 font-medium hover:underline">

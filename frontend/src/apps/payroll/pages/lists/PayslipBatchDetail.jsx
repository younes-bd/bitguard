...
export default function PayslipBatchDetail() {
    ...
    const loadData = async () => {
        try {
            setLoading(true);
            const batchData = await erpService.get(`hrm/payslip-batches/${id}`);
            setBatch(batchData);
            
            const payslipsData = await erpService.get(`hrm/payslips`, { batch: id });
    ...
    const generatePayslips = async () => {
        ...
        try {
            setGenerating(true);
            const response = await erpService.post(`hrm/payslip-batches/${id}/generate_payslips`);

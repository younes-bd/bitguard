...
base = r"c:\Users\youne\Desktop\2-InfoTech\website\website13\frontend\src\apps"
hr_pages = os.path.join(base, "hr", "pages")

moves = [
    # (source_subpath, target_app, target_subpath)
    (r"lists\AttendanceLog.jsx", "attendances", r"pages\lists\AttendanceLog.jsx"),
    (r"lists\TimeTracking.jsx", "attendances", r"pages\lists\TimeTracking.jsx"),
    (r"lists\LeaveManagement.jsx", "timeoff", r"pages\lists\LeaveManagement.jsx"),
...
routes = {
    "attendances": """import React from 'react';
...
""",
    "timeoff": """import React from 'react';
import { Route } from 'react-router-dom';
...
# Rewrite hrRoutes.jsx to exclude moved components
...
export const hrRoutes = (
    <>
        ...
        <Route path="attendance" element={<Navigate to="/admin/attendances" replace />} />
        <Route path="time" element={<Navigate to="/admin/attendances/time" replace />} />
        <Route path="leaves" element={<Navigate to="/admin/timeoff" replace />} />

...
for path, comp_name, title, color in dashboards:
    full_path = os.path.join(BASE_DIR, path)
    os.makedirs(os.path.dirname(full_path), exist_ok=True)
    with open(full_path, "w") as f:
        f.write(template.format(component_name=comp_name, title=title, color=color))
    print(f"Created {full_path}")

print("All dashboard placeholders created successfully!")
